...
**
** Created: Thu Mar 24 17:42:27 2011
...
public:
    ...
    void setupUi(QMainWindow *ProgramWindow)
    {
        ...
        ProgramWindow->resize(476, 418);
        actionO_programie = new QAction(ProgramWindow);
        actionO_programie->setObjectName(QString::fromUtf8("actionO_programie"));
        actionUstawienia = new QAction(ProgramWindow);
        ...
        statusBar = new QStatusBar(ProgramWindow);
        statusBar->setObjectName(QString::fromUtf8("statusBar"));
        ProgramWindow->setStatusBar(statusBar);
        toolBar = new QToolBar(ProgramWindow);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        ProgramWindow->addToolBar(Qt::TopToolBarArea, toolBar);
    ...
    {
        ProgramWindow->setWindowTitle(QApplication::translate("ProgramWindow", "MainWindow", 0, QApplication::UnicodeUTF8));
        actionO_programie->setText(QApplication::translate("ProgramWindow", "O programie", 0, QApplication::UnicodeUTF8));
        actionUstawienia->setText(QApplication::translate("ProgramWindow", "Proxy", 0, QApplication::UnicodeUTF8));
        teraz->setText(QApplication::translate("ProgramWindow", "Teraz", 0, QApplication::UnicodeUTF8));
        Okladka->setText(QString());
        wykonawca->setText(QApplication::translate("ProgramWindow", "Wykonawca:", 0, QApplication::UnicodeUTF8));
        tytul->setText(QApplication::translate("ProgramWindow", "Tytul:", 0, QApplication::UnicodeUTF8));
        plyta->setText(QApplication::translate("ProgramWindow", "P\305\202yta:", 0, QApplication::UnicodeUTF8));
        rok->setText(QApplication::translate("ProgramWindow", "Rok", 0, QApplication::UnicodeUTF8));
        TerazWykonawca->setText(QString());
        TerazTytul->setText(QString());
        TerazPlyta->setText(QString());
        TerazRok->setText(QString());
        label->setText(QApplication::translate("ProgramWindow", "Nast\304\231pna", 0, QApplication::UnicodeUTF8));
        NastepnaOkladka->setText(QString());
        label_2->setText(QApplication::translate("ProgramWindow", "Wykonawca:", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("ProgramWindow", "Tytul:", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("ProgramWindow", "P\305\202yta:", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("ProgramWindow", "Rok:", 0, QApplication::UnicodeUTF8));
        NastepnaWykonawca->setText(QString());
        NastepnaTytul->setText(QString());
        NastepnaPlyta->setText(QString());
        NastepnaRok->setText(QString());
        play_pause->setText(QApplication::translate("ProgramWindow", "Play", 0, QApplication::UnicodeUTF8));
        header->setText(QString());
        menuUstawienia->setTitle(QApplication::translate("ProgramWindow", "Ustawienia", 0, QApplication::UnicodeUTF8));
        menuPomoc->setTitle(QApplication::translate("ProgramWindow", "Pomoc", 0, QApplication::UnicodeUTF8));
        toolBar->setWindowTitle(QApplication::translate("ProgramWindow", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
