...
# Generated by qmake (2.01a) (Qt 4.7.0) on: wt. lip 5 18:15:12 2011
...
SOURCES       = options.cpp \
		...
		parser.cpp \
		imageload.cpp \
		proxydialog.cpp moc_options.cpp \
		moc_mainwindow.cpp \
		moc_trackinfo.cpp \
		moc_parser.cpp \
		moc_imageload.cpp \
...
$(TARGET): ui_options.h ui_oknoprogramu.h ui_proxyDialog.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents options.h mainwindow.h trackinfo.h parser.h lista.h imageload.h proxydialog.h .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents options.cpp main.cpp mainwindow.cpp trackinfo.cpp parser.cpp imageload.cpp proxydialog.cpp .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents options.ui oknoprogramu.ui proxyDialog.ui .tmp/MiastoMuzyki1.0.0/ && (cd `dirname .tmp/MiastoMuzyki1.0.0` && $(TAR) MiastoMuzyki1.0.0.tar MiastoMuzyki1.0.0 && $(COMPRESS) MiastoMuzyki1.0.0.tar) && $(MOVE) `dirname .tmp/MiastoMuzyki1.0.0`/MiastoMuzyki1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/MiastoMuzyki1.0.0
...
compiler_moc_header_make_all: moc_options.cpp moc_mainwindow.cpp moc_trackinfo.cpp moc_parser.cpp moc_imageload.cpp moc_proxydialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_options.cpp moc_mainwindow.cpp moc_trackinfo.cpp moc_parser.cpp moc_imageload.cpp moc_proxydialog.cpp
moc_options.cpp: ui_options.h \
		options.h
	/home/skoczo/qtsdk-2010.05/qt/bin/moc $(DEFINES) $(INCPATH) options.h -o moc_options.cpp
...
compiler_uic_make_all: ui_options.h ui_oknoprogramu.h ui_proxyDialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_options.h ui_oknoprogramu.h ui_proxyDialog.h
ui_options.h: options.ui
	/home/skoczo/qtsdk-2010.05/qt/bin/uic options.ui -o ui_options.h
