...
# Generated by qmake (2.01a) (Qt 4.7.0) on: pon. gru 20 18:08:22 2010
...
$(TARGET): ui_mainwindow.h ui_oknoprogramu.h ui_loader.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents mainwindow.h parser.h dataupdater.h trackinfo.h lista.h imageload.h oknoprogramu.h loader.h .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp parser.cpp dataupdater.cpp trackinfo.cpp imageload.cpp oknoprogramu.cpp loader.cpp .tmp/MiastoMuzyki1.0.0/ && $(COPY_FILE) --parents mainwindow.ui oknoprogramu.ui loader.ui .tmp/MiastoMuzyki1.0.0/ && (cd `dirname .tmp/MiastoMuzyki1.0.0` && $(TAR) MiastoMuzyki1.0.0.tar MiastoMuzyki1.0.0 && $(COMPRESS) MiastoMuzyki1.0.0.tar) && $(MOVE) `dirname .tmp/MiastoMuzyki1.0.0`/MiastoMuzyki1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/MiastoMuzyki1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_dataupdater.cpp moc_trackinfo.cpp moc_imageload.cpp moc_oknoprogramu.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_dataupdater.cpp moc_trackinfo.cpp moc_imageload.cpp moc_oknoprogramu.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_oknoprogramu.h ui_loader.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_oknoprogramu.h ui_loader.h
